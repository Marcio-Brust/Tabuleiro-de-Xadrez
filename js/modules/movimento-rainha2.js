export default function initiMovimentoRainha2() {
        ...
        for (let i = 0; i < pontoPeca.length; i++) {
          if (pontoPeca[i].classList.contains("movimento")) {
            for (let n = 0; ; n += 9) {
              ...
              if (pontoPeca[i - 9 - n].classList.contains("branco")) {
                break;
              }
              if (pontoPeca[i - 9 - n].classList.contains("preto")) {
                pontoPeca[i - 9 - n].classList.add("ativo");
              ...
              if (
                pontoPeca[i - 9 - n].classList.contains("a1") ||
                pontoPeca[i - 9 - n].classList.contains("a2") ||
                pontoPeca[i - 9 - n].classList.contains("a3") ||
                pontoPeca[i - 9 - n].classList.contains("a4") ||
                pontoPeca[i - 9 - n].classList.contains("a5") ||
                pontoPeca[i - 9 - n].classList.contains("a6") ||
                pontoPeca[i - 9 - n].classList.contains("a7") ||
                pontoPeca[i - 9 - n].classList.contains("a8") ||
                pontoPeca[i - 9 - n].classList.contains("b8") ||
                pontoPeca[i - 9 - n].classList.contains("c8") ||
                pontoPeca[i - 9 - n].classList.contains("d8") ||
                pontoPeca[i - 9 - n].classList.contains("e8") ||
                pontoPeca[i - 9 - n].classList.contains("f8") ||
                pontoPeca[i - 9 - n].classList.contains("g8") ||
                pontoPeca[i - 9 - n].classList.contains("h8")
              ) {
                break;
              }
            }
          ...
          if (pontoPeca[i].classList.contains("movimento")) {
            for (let n = 0; ; n += 9) {
              ...
              if (
                pontoPeca[i + 9 + n].classList.contains("h1") ||
                pontoPeca[i + 9 + n].classList.contains("h2") ||
                pontoPeca[i + 9 + n].classList.contains("h3") ||
                pontoPeca[i + 9 + n].classList.contains("h4") ||
                pontoPeca[i + 9 + n].classList.contains("h5") ||
                pontoPeca[i + 9 + n].classList.contains("h6") ||
                pontoPeca[i + 9 + n].classList.contains("h7") ||
                pontoPeca[i + 9 + n].classList.contains("h8") ||
                pontoPeca[i + 9 + n].classList.contains("a1") ||
                pontoPeca[i + 9 + n].classList.contains("b1") ||
                pontoPeca[i + 9 + n].classList.contains("c1") ||
                pontoPeca[i + 9 + n].classList.contains("d1") ||
                pontoPeca[i + 9 + n].classList.contains("e1") ||
                pontoPeca[i + 9 + n].classList.contains("f1") ||
                pontoPeca[i + 9 + n].classList.contains("g1")
              ) {
                break;
              }
            }
